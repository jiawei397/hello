...
public class MongoTest {
	...
	public static void main(String[] args) {
		...
		try {
			mongoClient = MongoUtil.getMongoClientByCredent();
//			mongoClient = MongoUtil.getMongoClientByURI();
			// 连接到 mongodb 服务
			// MongoClient mongoClient = new MongoClient( "127.0.0.1" , 27018 );
			// MongoClient mongoClient = new MongoClient( "192.168.10.64" ,
			// 27017 );

//			DB adminDb = mongoClient.getDB("admin");
//			System.out.println("Connect to database " + adminDb.getName()
//					+ " successfully");
			// WriteResult addUser = adminDb.addUser("root",
			// "369258".toCharArray());
			// System.out.println(addUser);
			// Set<String> collectionNames = adminDb.getCollectionNames();
			...
			System.out.println("Connect to database " + mongoDatabase.getName()
					+ " successfully");
